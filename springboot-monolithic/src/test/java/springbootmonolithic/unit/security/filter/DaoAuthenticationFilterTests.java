package springbootmonolithic.unit.security.filter;
...
class DaoAuthenticationFilterTests {
    ...
    void loginSuccess() throws Exception {
        ...
        assertThat(result.getName()).isEqualTo("signed up user");
        assertThat(result.getCredentials()).isEqualTo("correct password");
